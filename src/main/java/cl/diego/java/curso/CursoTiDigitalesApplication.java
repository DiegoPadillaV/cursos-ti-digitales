		...
		return args -> {
			...
			if(cRepo.count() == 0) {
				Curso cursoJava = Curso.builder()
										...
										.fechaInicio(LocalDate.of(2022, 6, 30))
										.fechaFin(LocalDate.of(2023, 1, 1))
										.cupos(30)
				...
				Curso cursoSpring = Curso.builder()
										...
										.fechaInicio(LocalDate.of(2022, 6, 30))
										.fechaFin(LocalDate.of(2023, 2, 1))
										.cupos(30)
				...
				Curso cursoOracle = Curso.builder()
										...
										.fechaInicio(LocalDate.of(2022, 6, 20))
										.fechaFin(LocalDate.of(2023, 3, 10))
										.cupos(30)
